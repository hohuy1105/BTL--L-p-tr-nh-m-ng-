...
Email liên hệ: hoquanghuyhb1@gmail.com  - Tại ô tìm kiếm trên cùng, gõ chữ: `esp32`. Tìm thấy gói mạch **`esp32` by `Espressif Systems`**, Huy nhấn nút **`Install`** màu xanh. Đợi khoảng 1 phút để máy tải về thành công cho đến khi chuyển sang màu xám báo chữ `INSTALLED`.
* **Nạp Code nhúng:**
